...
{
    {
        ...
        else
        {
            XTESTS_TEST_INTEGER_EQUAL(0u, str.len);
            XTESTS_TEST_POINTER_NOT_EQUAL(NULL, str.ptr);
            XTESTS_TEST_MULTIBYTE_STRING_EQUAL("", str.ptr);
    ...
    {
        cstring_t   str =   cstring_t_DEFAULT;
        CSTRING_RC  rc  =   cstring_assign(&str, "");
    ...
    {
        cstring_t   str;
        CSTRING_RC  rc  =   cstring_create(&str, "");
    ...
    {
        cstring_t   str;
        CSTRING_RC  rc  =   cstring_createLen(&str, "", 0u);
...
static void test_1_4()
{
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(alphabet) - 1; ++i)
    {
        ...
        else
        {
            ...
            XTESTS_TEST_POINTER_NOT_EQUAL(NULL, str.ptr);
            XTESTS_TEST_MULTIBYTE_STRING_EQUAL(s, static_cast<char const*>(str.ptr));
...
static void test_1_5()
{
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(alphabet) - 1; ++i)
    {
        ...
        else
        {
            XTESTS_TEST_INTEGER_EQUAL(cch, str.len);
            XTESTS_TEST_POINTER_NOT_EQUAL(NULL, str.ptr);
            XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N(s, static_cast<char const*>(str.ptr), int(i));
            XTESTS_TEST_INTEGER_GREATER_OR_EQUAL(cch, str.capacity);
            XTESTS_TEST_INTEGER_GREATER_OR_EQUAL(str.len, str.capacity);
...
{
    {
        ...
        { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(alphabet) - 1; ++i)
        {
            ...
            else
            {
                ...
                XTESTS_TEST_POINTER_NOT_EQUAL(NULL, str.ptr);
                XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N(alphabet, static_cast<char const*>(str.ptr), int(i));
...
static void test_2_1()
{
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(alphabet) - 1; ++i)
    {
        ...
        char const* const   s   =   alphabet + n;

        cstring_create(&str, s);

        XTESTS_TEST_INTEGER_GREATER_OR_EQUAL(i, str.len);
        XTESTS_TEST_MULTIBYTE_STRING_EQUAL(s, str.ptr);
        XTESTS_TEST_INTEGER_GREATER_OR_EQUAL(str.len, str.capacity);
...
static void test_2_3()
{
    ...
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(alphabet) - 1; ++i)
    {
        ...
        char                buff[]  =   "[01234567890123456789]";
        CSTRING_RC          rc;

        rc = cstring_createEx(&str, s, flags, &buff[0] + 1, STLSOFT_NUM_ELEMENTS(buff) - 3);

        XTESTS_TEST_CHARACTER_EQUAL('[', buff[0]);
        XTESTS_TEST_CHARACTER_EQUAL(']', buff[STLSOFT_NUM_ELEMENTS(buff) - 2]);
        XTESTS_TEST_CHARACTER_EQUAL('\0', buff[STLSOFT_NUM_ELEMENTS(buff) - 1]);
...
static void test_2_7()
{
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(alphabet) - 1; ++i)
    {
        ...
        XTESTS_TEST_MULTIBYTE_STRING_EQUAL(s, static_cast<char const*>(str1.ptr));
        ...
        XTESTS_TEST_MULTIBYTE_STRING_EQUAL(s, static_cast<char const*>(str2.ptr));
...
static void test_2_8()
{
    ...
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(alphabet) - 1; ++i)
    {
        ...
        XTESTS_TEST_MULTIBYTE_STRING_EQUAL(s, static_cast<char const*>(p));
